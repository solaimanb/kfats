...
router.get("/enrolled", auth_middleware_1.protect, course_controller_1.default.getEnrolledCourses);
router.get("/mentor/courses", auth_middleware_1.protect, (0, auth_middleware_1.restrictTo)(rbac_config_1.UserRole.MENTOR), course_controller_1.default.getMentorCourses);
