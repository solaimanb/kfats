...
export function CoursesPageClient() {
  ...
  const queryParams = useMemo(() => ({
    ...
    sort_by: sortBy === "newest" ? "created_at" :
             ...
             sortBy === "popular" ? "enrolled_count" : "created_at",
    sort_order: sortBy === "newest" || sortBy === "price-high" || sortBy === "popular" ? "desc" : "asc",
  }), [currentPage, selectedLevel, debouncedSearchQuery, sortBy]);
  ...
  const pagination = {
    ...
    pages: coursesResponse?.pages || 0,
  };

  useEffect(() => {
    setCurrentPage(1);
  }, [selectedLevel, debouncedSearchQuery, sortBy]);
