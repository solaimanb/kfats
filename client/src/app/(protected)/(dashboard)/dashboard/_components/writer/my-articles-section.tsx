...
import { formatNumber, getArticleStatusColor, calculateReadingTime } from "./utils"
import {
    PenTool,
    Eye,
    Edit,
                ...
                {sortedArticles.length > 0 ? (
                            ...
                            >
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <Badge
                                            variant="outline"
                                            className={`text-xs ${getArticleStatusColor(article.status)}`}
                                        >
                                            {article.status}
                                        </Badge>
                                    </div>
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className="text-sm text-muted-foreground mb-6 max-w-sm mx-auto">
                            Start writing your first article to share your knowledge and expertise with readers.
                        </p>
