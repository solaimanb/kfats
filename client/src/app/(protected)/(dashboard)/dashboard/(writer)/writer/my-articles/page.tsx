...
import { MyArticlesSection } from "@/app/(protected)/(dashboard)/dashboard/(writer)/writer/_components";
import { PenTool, AlertTriangle, UserPlus, ArrowLeft } from "lucide-react";
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              You need writer privileges to access this page and manage
              articles.
            </CardDescription>
          </CardHeader>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground">
            Manage your published content, track performance, and create new
            articles
          </p>
        </div>
